    ...
    >
      ...
      <div className="relative z-10 mx-auto grid min-h-[calc(100vh-7rem)] max-w-7xl items-center gap-12 lg:grid-cols-[1.08fr_0.92fr]">
        <div className="space-y-8">
          <div className="inline-flex items-center gap-3 rounded-md border border-black/10 bg-[#ffffff] px-3 py-2 font-mono text-xs uppercase text-zinc-600 shadow-[4px_4px_0_rgba(251,191,36,0.12)] dark:border-white/10 dark:bg-black/30 dark:text-zinc-300 dark:shadow-[4px_4px_0_rgba(251,191,36,0.08)]">
            <span className="h-2 w-2 bg-amber-500 dark:bg-amber-300"></span>
            Available for selected computer engineering work
          </div>

          <div className="space-y-6">
            <p className="flex items-center gap-2 font-mono text-sm uppercase text-emerald-600 dark:text-emerald-400">
        ...
        <div className="relative pb-16 lg:pb-0">
          <div className="rounded-lg border border-black/10 bg-zinc-950 text-[#ffffff] shadow-[18px_18px_0_rgba(251,191,36,0.14)] dark:border-white/10 dark:bg-[#0a0a0a] dark:shadow-[18px_18px_0_rgba(251,191,36,0.08)]">
