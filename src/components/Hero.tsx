        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <button 
              ...
              className="bg-gradient-to-r from-sky-600 to-blue-600 dark:from-sky-500 dark:to-blue-500 text-white px-8 py-3 rounded-full font-semibold hover:scale-105 transition-transform duration-200 shadow-lg hover:shadow-sky-500/25"
            >
              View My Work
            </button>
