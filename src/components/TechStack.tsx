    ...
    >
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="mb-16 grid gap-6 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
          <div className="inline-flex w-fit items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/5 px-3 py-1.5 font-mono text-[11px] uppercase tracking-widest text-emerald-700 dark:border-emerald-400/30 dark:bg-emerald-400/5 dark:text-emerald-400">
          ...
          <h2 className="text-4xl font-black leading-[1.05] tracking-tight text-zinc-950 dark:text-white sm:text-5xl">
            ...
            <br />
            <span className="text-emerald-600 dark:text-emerald-400">wired into one system.</span>
          </h2>
        ...
        <div className="grid gap-8 lg:grid-cols-[0.32fr_0.68fr]">
              ...
              return (
                <button
                  ...
                  className={`group flex items-center justify-between gap-3 rounded-xl border px-4 py-4 text-left transition-all duration-200 ${
                    isActive
                      ? "border-emerald-500/40 bg-emerald-500/[0.06] dark:border-emerald-400/40 dark:bg-emerald-400/[0.06]"
                      : "border-black/8 bg-transparent hover:border-emerald-500/25 hover:bg-emerald-500/[0.03] dark:border-white/8 dark:hover:border-emerald-400/25 dark:hover:bg-emerald-400/[0.04]"
                  }`}
                >
                    ...
                    <span
                      className={`grid h-9 w-9 place-items-center rounded-lg transition-colors ${
                        isActive
                          ...
                          : "bg-black/5 text-zinc-700 group-hover:bg-emerald-500/15 group-hover:text-emerald-700 dark:bg-white/5 dark:text-zinc-300 dark:group-hover:bg-emerald-400/15 dark:group-hover:text-emerald-400"
                      }`}
                    >
                  ...
                  <span
                    className={`h-1.5 w-1.5 rounded-full transition-all ${
                      isActive ? "bg-emerald-500 dark:bg-emerald-400" : "bg-transparent"
                    }`}
                  />
                </button>
              );
          ...
          {/* Canvas */}
          <div className="relative rounded-2xl border border-black/8 bg-white/40 p-6 backdrop-blur-sm dark:border-white/8 dark:bg-white/[0.02] sm:p-8">
            <div className="mb-8 flex items-start justify-between gap-4 border-b border-black/8 pb-6 dark:border-white/8">
              ...
              <span className="hidden items-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/5 px-3 py-1 font-mono text-[10px] uppercase tracking-widest text-emerald-700 dark:border-emerald-400/25 dark:bg-emerald-400/5 dark:text-emerald-400 sm:inline-flex">
            ...
            <ul className="grid gap-3 sm:grid-cols-2">
              {active.technologies.map((tech) => {
                ...
                return (
                  <li
                    key={tech.name}
                    className="group/item relative flex flex-col gap-4 rounded-xl border border-black/6 bg-white/70 p-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-emerald-500/35 hover:shadow-[0_8px_24px_-12px_rgba(16,185,129,0.35)] dark:border-white/8 dark:bg-white/[0.03] dark:hover:border-emerald-400/35"
                  >
