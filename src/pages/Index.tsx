  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-neutral-900 to-black transition-all duration-500">
      <div className="relative">
        ...
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-r from-purple-900/25 to-pink-900/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-gradient-to-r from-blue-900/25 to-purple-900/20 rounded-full blur-3xl animate-pulse delay-1000"></div>
